...
<table>
  <tbody>
    ...
    <tr>
      ...
      <td align="center">Showcase Controller</td>
      <td>получение описания конкретного приложения</td>
      <td>отправить запрос на получение описания конкретного приложения</td>
      <td align="center">идентификатор приложения</td>
      <td>полное описание конкретного приложения</td>
      <td>получение подробного описания приложения</td>
    </tr>
    <tr>
      <td align="center">2</td>
      <td align="center">Showcase Controller</td>
      <td>[C] установка приложения на виртуалку</td>
      <td>отправить запрос на установку</td>
      <td>
        <ul>
            <li>идентификатор приложения</li>
            <li>идентификатор пользователя</li>
            <li>настройки приложения</li>
            <li>данные виртуалки</li>
        </ul>
      </td>
      <td></td>
      <td>установка приложения на виртуалку</td>
    </tr>
    <tr>
      <td align="center">3</td>
      <td align="center">Showcase Controller</td>
      <td>[R] получение детальной информации по последним установкам приложения на виртуалки</td>
      <td>отправить запрос на получение детальной информации по последним установкам</td>
      <td>
        <ul>
            <li>идентификатор приложения</li>
            <li>идентификатор пользователя</li>
      ...
      <td>детальная информация по последним установкам приложения на виртуалки</td>
      <td>получение детальной информации по последним установкам приложения на виртуалки</td>
    </tr>
    <tr>
      <td align="center">4</td>
      <td align="center">Showcase Controller</td>
      <td>[D] удаление приложения с виртуалки</td>
      <td>отправить запрос на удаление</td>
      <td>идентификатор записи об установке</td>
      <td></td>
      <td>удаление приложения с виртуалки</td>
    </tr>
    <tr>
      <td align="center">5</td>
      <td align="center">Ansible Playbook </td>
      <td>получение статуса конкретной установки приложения на виртуалку</td>
      <td>отправить запрос на получение статуса</td>
      <td>
        <ul>
            <li>идентификатор приложения</li>
            <li>идентификатор записи об установке</li>
        </ul>
      </td>
      <td>статус установки</td>
      <td>убедиться в том, что запись об установке помечена, как взятая Ansible в обработку</td>
    </tr>
    <tr>
      <td align="center">6</td>
      <td align="center">Ansible Playbook</td>
      <td>изменение статуса конкретной установки приложения на виртуалку</td>
      <td>отправить запрос на изменение статуса</td>
      <td>
        <ul>
            <li>идентификатор приложения</li>
            <li>идентификатор записи об установке</li>
      ...
      <td></td>
      <td>перевод статуса установки приложения в done/exception</td>
    </tr>
  </tbody>
</table>
<br />
